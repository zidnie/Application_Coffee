package com.appcoffe.app.data.local

import android.content.Context
import android.content.SharedPreferences
import com.appcoffe.app.data.model.ActionState
import com.appcoffe.app.data.model.AuthUser
import com.appcoffe.app.util.getObject
import com.appcoffe.app.util.putObject
...
class AuthPref(val context:Context) {
    ...
    suspend fun login(email: String, password: String): ActionState<AuthUser> {
        ...
        return if (user==null){
            ...
            isLogin = true
            ActionState(massage = "Anda berhasil login")
        } else {
